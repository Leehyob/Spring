...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.8rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
      <a href="#place" class="step">STEP2<br>장소 선택
      ...
      <li>
      <a href="#hotel" class="step">STEP3<br>숙소 설정</a>
	...
	$(document).ready(function(){
		...
		function updateHtml() {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                str += "<input name='c_number' value='" + (i + 1) + "' style='width:23px; color:white; background-color:skyblue; border-radius: 50%; border-color: wheat;'>";
        ...
        $(document).on("click", ".deleteBtn", function() {
        	var result = confirm("장소를 삭제하시겠습니까?");
        	if(result){
