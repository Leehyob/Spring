...
public class BoardControllerTest {
	...
	public void testGet() throws Exception {
		ModelMap modelMap =  mockMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "1"))
	...
	public void testRegister() throws Exception{
		String viewName = mockMvc.perform(MockMvcRequestBuilders.post("/board/register")
				.param("title", "목업 제목").param("content", "목업 내용").param("writer", "목업자"))
	...
	public void testModify() throws Exception{
		String viewName = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify")
				.param("title", "목업 수정 제목").param("content", "목업 수정 내용")
				.param("writer", "목업수정자").param("bno", "4"))
		.andReturn().getModelAndView().getViewName();
